...
from recsys.Recommenders.Similarity.Compute_Similarity_Python import Compute_Similarity_Python
from recsys.Recommenders.Similarity.Compute_Similarity_Euclidean import Compute_Similarity_Euclidean
    ...
    def __init__(self, dataMatrix, use_implementation = "density", similarity = None, **args):
        ...
        if similarity == "euclidean":
            ...
            if use_implementation == "cython":
                ...
                try:
                    from recsys.Recommenders.Similarity.Cython.Compute_Similarity_Cython import Compute_Similarity_Cython
