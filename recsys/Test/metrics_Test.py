...
class MyTestCase(unittest.TestCase):
    ...
    def test_Gini_Index(self):
        ...
        from recsys.Evaluation.metrics import Gini_Diversity
    ...
    def test_Shannon_Entropy(self):
        ...
        from recsys.Evaluation.metrics import Shannon_Entropy
    ...
    def test_Diversity_list_all_equals(self):
        ...
        from recsys.Evaluation.metrics import Diversity_MeanInterList
    ...
    # def test_AUC(self):
    #
    #     from recsys.Evaluation.metrics import roc_auc
    #
    ...
    def test_Recall(self):
        ...
        from recsys.Evaluation.metrics import recall
    ...
    def test_Precision(self):
        ...
        from recsys.Evaluation.metrics import precision
    ...
    def test_RR(self):
        ...
        from recsys.Evaluation.metrics import rr
    ...
    # def test_MAP(self):
    #
    #     from recsys.Evaluation.metrics import map
    #
    #     pos_items = np.asarray([2, 4, 5, 10])
    #     ranked_list_1 = np.asarray([1, 2, 3, 4, 5])
    #     ranked_list_2 = np.asarray([10, 5, 2, 4, 3])
    ...
    def test_NDCG(self):
        ...
        from recsys.Evaluation.metrics import dcg, ndcg
