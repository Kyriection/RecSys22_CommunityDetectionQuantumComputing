...
class MovielensSample2Reader(DataReader):

    # DATASET_URL = "http://files.grouplens.org/datasets/movielens/ml-1m.zip"
    DATASET_SUBFOLDER = "MovielensSample2/"
    ...
    def _load_from_original_file(self):
        ...
        ICM_genre_path = dataFile.extract("ml-sample/movies.dat", path=zipFile_path + "decompressed/")
        UCM_path = dataFile.extract("ml-sample/users.dat", path=zipFile_path + "decompressed/")
        URM_path = dataFile.extract("ml-sample/ratings.dat", path=zipFile_path + "decompressed/")
