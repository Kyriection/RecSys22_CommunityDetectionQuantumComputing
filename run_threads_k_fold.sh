...
{
  echo Each Item
  time python CT_recommendation.py -d $dataset -k $n_folds --EI -o results/EI > logs/ctr-EI.log 2>&1
  echo ''>&5
}&
# ------------- Total Clusetring ----------
# ------------- Classical ----------
read -u5
{
  ...
  time python CT_recommendation.py -d $dataset -k $n_folds -o results/Kmeans-T > logs/ctr-Kmeans-T.log 2>&1
  echo ''>&5
}&
read -u5
{
  echo Kmeans Total w/ attribute
  time python CT_recommendation.py -d $dataset -k $n_folds --attribute -o results/Kmeans-T-A > logs/ctr-Kmeans-T-A.log 2>&1
  echo ''>&5
}&
read -u5
{
  echo Kmeans Bipartite w/o attribute
  time python kfold_LT_community_detection.py KmeansCommunityDetection -d $dataset -k $n_folds -o results/Kmeans-B > logs/ctcd-Kmeans-B.log 2>&1
  time python kfold_LT_qa_recommendation.py   KmeansCommunityDetection -d $dataset -k $n_folds -o results/Kmeans-B > logs/ctqr-Kmeans-B.log 2>&1
  echo ''>&5
}&
read -u5
{
  echo Kmeans Bipartite w/ attribute
  time python kfold_LT_community_detection.py KmeansCommunityDetection -d $dataset -k $n_folds --attribute -o results/Kmeans-B-A > logs/ctcd-Kmeans-B-A.log 2>&1
  time python kfold_LT_qa_recommendation.py   KmeansCommunityDetection -d $dataset -k $n_folds --attribute -o results/Kmeans-B-A > logs/ctqr-Kmeans-B-A.log 2>&1
  echo ''>&5
}&
# ------------- Quantum -----------------
# read -u5
...
#   time python kfold_LT_community_detection.py QUBOBipartiteCommunityDetection -o results/BM > logs/ctcd-BM.log 2>&1
#   time python kfold_LT_qa_recommendation.py QUBOBipartiteCommunityDetection -o results/BM > logs/ctqr-BM.log 2>&1
#   echo ''>&5
# }&
read -u5
{
...
#         echo $tag
#         time python kfold_LT_community_detection.py $method --attribute -b $beta -a $alpha -t $T -o results/$tag > logs/ctcd-$tag.log 2>&1
#         time python kfold_LT_qa_recommendation.py   $method --attribute -b $beta -a $alpha -t $T -o results/$tag > logs/ctqr-$tag.log 2>&1
#       done
#     done
#   done
# done
...
#   time python kfold_LT_community_detection.py -c $cut -o results-$cut > logs/ctcd-$cut.log 2>&1
#   echo 'start recommendation'
#   time python kfold_LT_qa_recommendation.py -c $cut -o results-$cut > logs/ctqr-$cut.log 2>&1
#   echo ''>&5
# }&
# done
